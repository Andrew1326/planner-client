...
import {Button, Title, Container, List, Group, Text, ThemeIcon, Image, rem} from "@mantine/core";
  ...
  return <Container size="md">
    <div className={classes.inner}>
      <div className={classes.content}>
        ...
        >
          {pros.map((el, i) => <List.Item key={i}>{el}</List.Item>)}
        </List>

          <Button mt={30} radius="xl" size="md" className={classes.control} component={'a'} href={'/auth/register'}>
              Get started
          </Button>
      </div>
